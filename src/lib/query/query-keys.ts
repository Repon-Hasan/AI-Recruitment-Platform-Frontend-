export const queryKeys = {
  ...
  resumes: {
    ...
    detail: (id: string) =>
      ["resumes", "detail", id] as const,

    analysis: (id: string) =>
      ["resumes", "analysis", id] as const,
  },
  ...
  candidates: {
    ...
    detail: (id: string) =>
      ["candidates", "detail", id] as const,

    matches: (jobId: string) =>
      ["candidates", "matches", jobId] as const,
  },
